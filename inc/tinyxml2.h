...
class TINY_XML_EXPORT DynArray
{
public:
	DynArray< T, INIT >()
	{
...
*/
template< int SIZE >
class TINY_XML_EXPORT MemPoolT : public MemPool
{
public:
...
/**
	...
	@sa XMLNode::Accept()
*/
class TINY_XML_EXPORT XMLVisitor
{
public:
	virtual ~XMLVisitor() {}
...
*/
class TINY_XML_EXPORT XMLText : public XMLNode
{
...
/** An XML Comment. */
class TINY_XML_EXPORT XMLComment : public XMLNode
{
	friend class XMLDocument;
public:
...
*/
class TINY_XML_EXPORT XMLDeclaration : public XMLNode
{
	friend class XMLDocument;
public:
...
*/
class TINY_XML_EXPORT XMLUnknown : public XMLNode
{
	friend class XMLDocument;
public:
...
*/
class TINY_XML_EXPORT XMLAttribute
{
	friend class XMLElement;
public:
...
*/
class TINY_XML_EXPORT XMLElement : public XMLNode
{
	friend class XMLBase;
	friend class XMLDocument;
public:
...
*/
class TINY_XML_EXPORT XMLDocument : public XMLNode
{
	friend class XMLElement;
public:
	/// constructor
...
*/
class TINY_XML_EXPORT XMLHandle
{
public:
...
*/
class TINY_XML_EXPORT XMLConstHandle
{
public:
...
/**
	...
	@endverbatim
*/
class TINY_XML_EXPORT XMLPrinter : public XMLVisitor
{
public:
